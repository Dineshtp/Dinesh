...
class DetailsControllerTest < ActionController::TestCase
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post :create, detail: { age: @detail.age, email: @detail.email, name: @detail.name, school: @detail.school }
    end
  ...
  test "should update detail" do
    patch :update, id: @detail, detail: { age: @detail.age, email: @detail.email, name: @detail.name, school: @detail.school }
    assert_redirected_to detail_path(assigns(:detail))
  end
